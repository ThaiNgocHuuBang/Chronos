                  ...
                  <div>
                      <figure class="card card-product-grid">
                          <div class="img-wrap item-zoom">                       
                              ...
                              <a href="detail.html"><div class="titleProduct">${listBySearch[i].moventment.charAt(0).toUpperCase() + listBySearch[i].moventment.slice(1)}, ${listBySearch[i].strap.charAt(0).toUpperCase() + listBySearch[i].strap.slice(1)} Strap - ${listBySearch[i].size}mm (${listBySearch[i].codePd})</div></a>
                          </div>
